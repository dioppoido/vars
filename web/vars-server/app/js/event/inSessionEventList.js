...
exports.inSessionEventList = function(date,json,sort){
        ...
        for(var cnt=0;cnt<json.length;cnt++){
              ...
              if(holdfinish>=date){
                  ...
                  open[openNo].Holdperiod.Holdstart=todate.parsedate(json[cnt].Holdperiod.Holdstart,"YYYY年M月D日(dddd) HH時mm分");
                  open[openNo].Holdperiod.Holdfinish=todate.parsedate(json[cnt].Holdperiod.Holdfinish,"YYYY年M月D日(dddd) HH時mm分");
