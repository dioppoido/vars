        ...
        getExternal.getExternal({"Address":req.body.address},{}).then(function(userdata){
              ...
              var insertjson= {
                ...
                if(userdata==""){
                  ...
                  res.render('adminconfirmation.ejs',{msg:'ユーザーを追加しました',url:'/adminedit'});
                }else{
                  res.render('adminconfirmation.ejs',{msg:'そのユーザーはすでに追加されています',url:'/adminedit'});
                }
      });
    // }else{
      // res.redirect("/");
    ...
    // if(req.session.admin){
      ...
      if(address instanceof Array){
        for(var i=0;i<address.length;i++){
            ...
            res.render('adminconfirmation.ejs',{msg:'ユーザーを削除しました',url:'/adminedit'});
        // 選択肢一つ
      }else{
